    ...
    >
        <motion.div
          ...
          style={{
            ...
            border: "1px solid rgba(1,54,254,0.3)",
            boxShadow: "0 0 40px rgba(1,54,254,0.15)",
          }}
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              <Sparkles className="w-5 h-5" style={{ color: "#0136fe" }} />
              <h3 className="text-lg font-black text-[#0136fe]">Generate with AI</h3>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onFocus={(e) => (e.target.style.borderColor = countInvalid ? "rgba(244,67,54,0.7)" : "rgba(1,54,254,0.6)")}
                  onBlur={(e) => (e.target.style.borderColor = countInvalid ? "rgba(244,67,54,0.5)" : "rgba(1,54,254,0.2)")}
                />
                {countInvalid && (
              ...
              <motion.button
                ...
                style={{
                  ...
                  color: "#0136fe",
                  boxShadow: "0 6px 24px rgba(1,54,254,0.35)",
                }}
                whileHover={{ scale: 1.02, boxShadow: "0 8px 30px rgba(1,54,254,0.5)" }}
                whileTap={{ scale: 0.98 }}>
